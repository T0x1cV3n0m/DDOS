    ...
    if master == 'true':
            ...
            path = raw_input('Please drag this file on this terminal-window and press <enter>!\n>>> ')
     
            #instances
            instances_str = raw_input('How many instances do you want to open [1-200]?\nINFO:\nIf you enter a non valid number the default of 1 will be chosen!\n>>> ')
            ...
            #times
            times_str = raw_input('How often should be the host attacked by the script [1-1000000]?\nINFO:\If you enter a non valid number the default of 1000 will be chosen!\n>>> ')
            ...
            #host
            host = raw_input('Which host do you want to attack?\n>>> ')
            #print ('Host: ' + host)
            ...
            while afterSettingsLoop == 'y':
                    moveOn = raw_input('Do you want to start the attack with the settings above? [y/n]\nINFO:\nTo cancle the attack before completion press <ctrl> and <C>\n>>> ')
